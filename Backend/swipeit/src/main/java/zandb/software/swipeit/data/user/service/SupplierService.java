...
public class SupplierService {
    ...
    public SupplierDTO updateClient(SupplierDTO supplierDTO) throws UserNotFoundException, AccessDeniedException {
        ...
        return modelMapper.map(supplierRepository.saveAndFlush(modelMapper.map(supplierDTO, Supplier.class)), SupplierDTO.class);
    }
